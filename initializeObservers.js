...
let p1_games_led0 = new GameLed( "P1_GAMES_LED0", "green_game_1", "led-green-on", "led-green-off" );
let p1_games_led1 = new GameLed( "P1_GAMES_LED1", "green_game_2", "led-green-on", "led-green-off" );
let p1_games_led2 = new GameLed( "P1_GAMES_LED2", "green_game_3", "led-green-on", "led-green-off" );
let p1_games_led3 = new GameLed( "P1_GAMES_LED3", "green_game_4", "led-green-on", "led-green-off" );
let p1_games_led4 = new GameLed( "P1_GAMES_LED4", "green_game_5", "led-green-on", "led-green-off" );
let p1_games_led5 = new GameLed( "P1_GAMES_LED5", "green_game_6", "led-green-on", "led-green-off" );
let p1_games_led6 = new GameLed( "P1_GAMES_LED6", "green_game_7", "led-green-on", "led-green-off" );

let p2_games_led0 = new GameLed( "P2_GAMES_LED0", "red_game_1", "led-red-on", "led-red-off" );
let p2_games_led1 = new GameLed( "P2_GAMES_LED1", "red_game_2", "led-red-on", "led-red-off" );
let p2_games_led2 = new GameLed( "P2_GAMES_LED2", "red_game_3", "led-red-on", "led-red-off" );
let p2_games_led3 = new GameLed( "P2_GAMES_LED3", "red_game_4", "led-red-on", "led-red-off" );
let p2_games_led4 = new GameLed( "P2_GAMES_LED4", "red_game_5", "led-red-on", "led-red-off" );
let p2_games_led5 = new GameLed( "P2_GAMES_LED5", "red_game_6", "led-red-on", "led-red-off" );
let p2_games_led6 = new GameLed( "P2_GAMES_LED6", "red_game_7", "led-red-on", "led-red-off" );
...
// let gameState = new GameState( dataSource, ledObserver );
// gameState.startGame();
